    ...
    <div id="content" class="tab-content active" data-tabid="tab1"><div id="login-wrapper">
            <div id="login-form">
                <div id="login-form-form">
                    ...
                    <div class="b-content">
                        <span class="b-text b-text_lang_en">Site underconstruction</span>
                        <span class="b-text b-text_lang_ru">На сайте ведутся технические работы</span>
                        <br/>
                        <span class="b-text b-text_lang_en">Work will be completed in the near future. Please reload the page.</span>
                        <span class="b-text b-text_lang_ru">Работы завершатся в ближайшее время. Попробуйте обновить страницу.</span>
                    </div>
                </div>
            </div>
            <div class="b-copyright">
                <a class="b-copyright__link" href="/" target="_blank">© <?= date('Y') ?></a>
            </div>
